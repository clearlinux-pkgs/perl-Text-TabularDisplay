...
cp %{_builddir}/Text-TabularDisplay-%{version}/COPYING %{buildroot}/usr/share/package-licenses/perl-Text-TabularDisplay/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1 || :
if test -f Makefile.PL; then
